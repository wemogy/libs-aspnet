...
using Wemogy.AspNetCore.Formatters;
using Wemogy.AspNetCore.Json;
using Wemogy.AspNetCore.Middlewares;
using Wemogy.AspNetCore.Monitoring;
using Wemogy.AspNetCore.Swagger;
using Wemogy.DataAccess.Setup;

namespace Wemogy.AspNetCore.Startup
{
    public static class StartupExtensions
    {
        ...
        public static void AddDefaultInternalSetup(this IServiceCollection serviceCollection, StartupOptions options)
        {
            serviceCollection.AddHeaderContext();

            serviceCollection.AddDefaultSetup(options);
        }
